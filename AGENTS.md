# AGENTS.md — aeo-engine

Guidance for Codex agents working in this project. These rules override
default behavior.
...
Specialist agents for delegated work. See `.Codex/agents/team/`.
...
The project uses Codex hooks via `.Codex/settings.json`:
